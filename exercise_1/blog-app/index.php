<?php
    ...
    function aciklama_kisitlama($aciklama){
        $bas_harf_buyuk= ucwords($aciklama);
        //Her kelimenin baş harfi için değilde her paragrafın ilk kelimesinin ilk harfi içinde ucfirst() fonksiyonu kullanırız.
        return substr($bas_harf_buyuk, 0, 50) . '...';
    }
            ...
            <div class="col-9">
                <div class="card mb-3">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="card-body">
                                <h1 class="card-title"><?php echo $baslik[0]?></h1>
                                <p class="card-text">
                                <?php echo aciklama_kisitlama($filmler["1"]["aciklama"])?>
                                </p>
                                <div>
                ...
                <div class="card mb-3">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="card-body">
                                <h1 class="card-title"><?php echo $baslik[1]?></h1>
                                <p class="card-text">
                                <?php echo aciklama_kisitlama($filmler["2"]["aciklama"])?>
                                </p>
                                <div>
                                    <span class="badge bg-success">Yapım Tarihi: 03.12.2021</span>
                ...
                <div class="card mb-3">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="card-body">
                                <h1 class="card-title"><?php echo $baslik[2]?></h1>
                                <p class="card-text">
                                <?php echo aciklama_kisitlama($filmler["0"]["aciklama"])?>
                                </p>
                                <div>
                                    <span class="badge bg-success">Yapım Tarihi: 03.12.2021</span>
